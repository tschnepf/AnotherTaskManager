...
class UserMobilePreference(models.Model):
    ...
    area_text_coloring_enabled = models.BooleanField(default=False)
    work_area_text_color = models.CharField(max_length=7, default="#93c5fd")
    personal_area_text_color = models.CharField(max_length=7, default="#86efac")
